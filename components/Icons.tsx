...
export const IconDollarSign = ({ className }: { className?: string }) => (
...
export const IconClipboardCheck = ({ className }: { className?: string }) => (
...
export const IconSquare = ({ className }: { className?: string }) => (
...
// New iOS Style Share Icon
export const IconIOSShare = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconThumbsDown = ({ className }: { className?: string }) => (
